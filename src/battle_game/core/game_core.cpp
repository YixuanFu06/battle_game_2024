...
void GameCore::SetScene() {
  ...
  // AddObstacle<obstacle::Block>(glm::vec2{-3.0f, -4.0f});
  AddObstacle<obstacle::Setter>(std::vector<glm::vec2>{
      {9.0f, 9.0f}, {9.2f, 9.0f}, {9.2f, -9.0f}, {9.0f, -9.0f}});
  AddObstacle<obstacle::Setter>(std::vector<glm::vec2>{
      {-9.0f, 9.0f}, {-9.2f, 9.0f}, {-9.2f, -9.0f}, {-9.0f, -9.0f}});
  AddObstacle<obstacle::Setter>(std::vector<glm::vec2>{
      {9.0f, 9.0f}, {9.0f, 9.2f}, {-9.0f, 9.2f}, {-9.0f, 9.0f}});
  AddObstacle<obstacle::Setter>(std::vector<glm::vec2>{
      {9.0f, -9.0f}, {9.0f, -9.2f}, {-9.0f, -9.2f}, {-9.0f, -9.0f}});
  AddObstacle<obstacle::Setter>(std::vector<glm::vec2>{
      {5.0f, -5.0f}, {6.0f, -6.0f}, {5.0f, -7.0f}, {4.0f, -6.0f}});
